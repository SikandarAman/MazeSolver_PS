function robot_state = init_robot(start_pos, start_dir)
    ...
    % Action tracking
    robot_state.actions = [];          % History of all actions
    robot_state.path = start_pos;      % History of positions
    ...
    robot_state.turning_points = [];  % Stores [row, col] positions where robot turned
